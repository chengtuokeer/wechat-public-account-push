  ...
  USERS: [
    {
      ...
      openUrl: 'guozhivip.com/eat/',
      // 专属节日提醒，如果你在这里填写了节日提醒，就不会执行FESTIVALS的提醒了, 和FESTIVALS的配置方法相同，可以往下查看，我这里就不重复写了
      festivals: [
        // 注意：此条配置日期为阴历日期，因为`type`中 “生日” 之前有 * 符号
        {
          type: '生日', name: '找毛笔', year: '2002', date: '02-19',isShowAge: true
        },
        {
          type: '生日', name: '张鹏', year: '2003', date: '05-06',isShowAge: true
        },{
          type: '生日', name: '赵芯瑞', year: '2003', date: '09-04', isShowAge: true
        },
      ],
